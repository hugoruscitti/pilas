...
class MensajeError(Actor):
    ...
    def iniciar(self):
        ...
        titulo = self.pilas.actores.Texto("ERROR: " + mensaje_titulo, y=150, ancho=500)
        descripcion = self.pilas.actores.Texto(mensaje_descripcion, magnitud=16, y=-80, ancho=500)
