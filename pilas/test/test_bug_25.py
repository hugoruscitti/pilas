...
class TestEscenasYTareas(unittest.TestCase):
    ...
    def test_se_eliminan_las_tareas_al_cambiar_de_escena(self):
        ...
        self.assertEqual(pilas.escena_actual().tareas.obtener_cantidad_de_tareas_planificadas(),
        ...
        self.assertEqual(pilas.escena_actual().tareas.obtener_cantidad_de_tareas_planificadas(), 0,
