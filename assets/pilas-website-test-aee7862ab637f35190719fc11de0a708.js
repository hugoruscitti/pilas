...
define('pilas-website-test/components/link-tutorial', ['exports', 'ember'], function (exports, Ember) {
...
define('pilas-website-test/components/p-api-bloque', ['exports', 'ember'], function (exports, Ember) {
...
define('pilas-website-test/components/p-api', ['exports', 'ember'], function (exports, Ember) {
...
define('pilas-website-test/components/p-codigo', ['exports', 'ember'], function (exports, Ember) {
...
define('pilas-website-test/components/p-markdown', ['exports', 'ember'], function (exports, Ember) {
...
define('pilas-website-test/controllers/application', ['exports', 'ember'], function (exports, Ember) {
...
define('pilas-website-test/mixins/google-pageview', ['exports', 'ember', 'pilas-website-test/config/environment'], function (exports, Ember, ENV) {
  ...
  exports['default'] = Ember['default'].Mixin.create({
    ...
    pageviewToGA: Ember['default'].on("didTransition", function (page, title) {
...
define('pilas-website-test/router', ['exports', 'ember', 'pilas-website-test/config/environment', 'pilas-website-test/mixins/google-pageview'], function (exports, Ember, config, googlePageview) {
...
define('pilas-website-test/routes/docs/guia-conversion', ['exports', 'ember'], function (exports, Ember) {
...
define('pilas-website-test/services/videos', ['exports', 'ember'], function (exports, Ember) {
  ...
  var videos = [{ id: 9, titulo: "Creando videojuegos con Pilas Engine", tipo: "youtube", url: "http://www.youtube.com/embed/JmjQfVBENMI" }, { id: 7, titulo: "Pilas en tv pública", tipo: "youtube", url: "http://www.youtube.com/embed/4KpLctdBrf8" }, { id: 8, titulo: "Pilas en WISIT 2014 (Argentina)", tipo: "youtube", url: "http://www.youtube.com/embed/l2nh3YYW29k" }, { id: 1, titulo: "Pilas en PyCon España 2013 (Madrid, España)", tipo: "youtube", url: "http://www.youtube.com/embed/bjlWZjTZLmQ" }, { id: 2, titulo: "Pilas en PyCon Argentina 2013 (Rosario, Argentina)", tipo: "youtube", url: "http://www.youtube.com/embed/tXA2BgzrvzA" }, { id: 3, titulo: "Pilas en PyCon Argentina 2012", tipo: "youtube", url: "http://www.youtube.com/embed/sQhxjLoJlZs" }, { id: 4, titulo: "Presentación de pilas en betabeers Bs. As. Marzo 2012", tipo: "youtube", url: "http://www.youtube.com/embed/-Z6Qi_B9QSA" }, { id: 5, titulo: "Haciendo videojuegos con pilas (pyday 2011)", tipo: "vimeo", url: "http://player.vimeo.com/video/23735704?title=0&amp;byline=0&amp;portrait=0" }, { id: 6, titulo: "Presentación Conurbania 2010", tipo: "vimeo", url: "http://player.vimeo.com/video/17273297" }];
...
define('pilas-website-test/templates/components/link-tutorial', ['exports', 'ember'], function (exports, Ember) {
  ...
  function program6(depth0,data) {
    ...
    data.buffer.push("Abrir");
    }

    data.buffer.push("    <td>\n      ");
    stack1 = (helper = helpers['link-to'] || (depth0 && depth0['link-to']),options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(1, program1, data),contexts:[depth0],types:["ID"],data:data},helper ? helper.call(depth0, "destino", options) : helperMissing.call(depth0, "link-to", "destino", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n    </td>\n\n    <td>\n\n     <h4>");
    stack1 = (helper = helpers['link-to'] || (depth0 && depth0['link-to']),options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(4, program4, data),contexts:[depth0],types:["ID"],data:data},helper ? helper.call(depth0, "destino", options) : helperMissing.call(depth0, "link-to", "destino", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("</h4>\n\n\n        <p>");
    stack1 = helpers._triageMustache.call(depth0, "descripcion", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data});
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("</p>\n        <ul style='margin-left: 1em; list-style-type: disc'>\n        <li>");
    stack1 = (helper = helpers['link-to'] || (depth0 && depth0['link-to']),options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(6, program6, data),contexts:[depth0],types:["ID"],data:data},helper ? helper.call(depth0, "destino", options) : helperMissing.call(depth0, "link-to", "destino", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("</li>\n     </ul>\n    </td>\n");
    return buffer;
...
define('pilas-website-test/templates/components/p-api-bloque', ['exports', 'ember'], function (exports, Ember) {
  ...
  function program1(depth0,data) {
    ...
    data.buffer.push("<div class=\"col-md-6\">\n<div class='p-api-bloque-title'>");
    stack1 = helpers._triageMustache.call(depth0, "titulo", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data});
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("</div>\n");
    options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(1, program1, data),contexts:[],types:[],data:data}
    if (helper = helpers['p-codigo']) { stack1 = helper.call(depth0, options); }
    else { helper = (depth0 && depth0['p-codigo']); stack1 = typeof helper === functionType ? helper.call(depth0, options) : helper; }
    if (!helpers['p-codigo']) { stack1 = blockHelperMissing.call(depth0, 'p-codigo', {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(1, program1, data),contexts:[],types:[],data:data}); }
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n</div>\n");
    return buffer;
...
define('pilas-website-test/templates/components/p-api', ['exports', 'ember'], function (exports, Ember) {
  ...
  helpers = this.merge(helpers, Ember['default'].Handlebars.helpers); data = data || {};
    ...
    data.buffer.push("<div class=\"row p-api\">\n  ");
    stack1 = helpers._triageMustache.call(depth0, "yield", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data});
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n</div>\n");
    return buffer;
...
define('pilas-website-test/templates/components/p-codigo', ['exports', 'ember'], function (exports, Ember) {
  ...
  helpers = this.merge(helpers, Ember['default'].Handlebars.helpers); data = data || {};
    ...
    data.buffer.push("<code class=\"language-python\">");
    stack1 = helpers._triageMustache.call(depth0, "yield", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data});
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
...
define('pilas-website-test/templates/components/p-markdown', ['exports', 'ember'], function (exports, Ember) {
  ...
  helpers = this.merge(helpers, Ember['default'].Handlebars.helpers); data = data || {};
    ...
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n</div>\n\n");
    data.buffer.push(escapeExpression(helpers._triageMustache.call(depth0, "safehtml", {hash:{
      'unescaped': ("true")
...
define('pilas-website-test/templates/descargas', ['exports', 'ember'], function (exports, Ember) {
  ...
  helpers = this.merge(helpers, Ember['default'].Handlebars.helpers); data = data || {};
    ...
    data.buffer.push("><div class='sprite ico-ubuntu'></div> Ubuntu Linux</a></li>\n    </ul>\n  </div>\n\n  <div class='row'>\n\n    <div class=\"col-lg-3\"></div>\n\n    <div class=\"col-lg-6\">\n    <p>También podés encontrar las versiones anteriores de pilas en <a href='https://www.dropbox.com/sh/pv0vu4id6dqqojh/AACy-7fqG1CpJlHXbqgOR2q6a?dl=0' target=\"_blank\">este link</a> o instalar la versión más reciente para desarrolladores desde nuestro repositorio <a href='https://github.com/hugoruscitti/pilas/wiki/instalacion' target=\"_blank\">con esta guía</a>.</p>\n    </div>\n\n    <div class=\"col-lg-3\"></div>\n  </div>\n</div>\n");
    return buffer;
...
define('pilas-website-test/templates/docs/disparar-a-monos', ['exports', 'ember'], function (exports, Ember) {
  ...
  function program25(depth0,data) {
    ...
    stack1 = (helper = helpers['link-to'] || (depth0 && depth0['link-to']),options={hash:{
      'class': ("btn btn-info")
    },hashTypes:{'class': "STRING"},hashContexts:{'class': depth0},inverse:self.noop,fn:self.program(1, program1, data),contexts:[depth0],types:["STRING"],data:data},helper ? helper.call(depth0, "docs", options) : helperMissing.call(depth0, "link-to", "docs", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    ...
    options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(3, program3, data),contexts:[],types:[],data:data}
    if (helper = helpers['p-markdown']) { stack1 = helper.call(depth0, options); }
    else { helper = (depth0 && depth0['p-markdown']); stack1 = typeof helper === functionType ? helper.call(depth0, options) : helper; }
    if (!helpers['p-markdown']) { stack1 = blockHelperMissing.call(depth0, 'p-markdown', {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(3, program3, data),contexts:[],types:[],data:data}); }
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    ...
    if (!helpers['p-markdown']) { stack1 = blockHelperMissing.call(depth0, 'p-markdown', {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(5, program5, data),contexts:[],types:[],data:data}); }
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n\n\n");
    options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(7, program7, data),contexts:[],types:[],data:data}
    if (helper = helpers['p-codigo']) { stack1 = helper.call(depth0, options); }
    else { helper = (depth0 && depth0['p-codigo']); stack1 = typeof helper === functionType ? helper.call(depth0, options) : helper; }
    if (!helpers['p-codigo']) { stack1 = blockHelperMissing.call(depth0, 'p-codigo', {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(7, program7, data),contexts:[],types:[],data:data}); }
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n\n\n\n");
    options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(9, program9, data),contexts:[],types:[],data:data}
    if (helper = helpers['p-markdown']) { stack1 = helper.call(depth0, options); }
    else { helper = (depth0 && depth0['p-markdown']); stack1 = typeof helper === functionType ? helper.call(depth0, options) : helper; }
    if (!helpers['p-markdown']) { stack1 = blockHelperMissing.call(depth0, 'p-markdown', {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(9, program9, data),contexts:[],types:[],data:data}); }
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n\n\n");
    options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(11, program11, data),contexts:[],types:[],data:data}
    if (helper = helpers['p-codigo']) { stack1 = helper.call(depth0, options); }
    else { helper = (depth0 && depth0['p-codigo']); stack1 = typeof helper === functionType ? helper.call(depth0, options) : helper; }
    if (!helpers['p-codigo']) { stack1 = blockHelperMissing.call(depth0, 'p-codigo', {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(11, program11, data),contexts:[],types:[],data:data}); }
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n\n\n\n");
    options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(13, program13, data),contexts:[],types:[],data:data}
    if (helper = helpers['p-markdown']) { stack1 = helper.call(depth0, options); }
    else { helper = (depth0 && depth0['p-markdown']); stack1 = typeof helper === functionType ? helper.call(depth0, options) : helper; }
    if (!helpers['p-markdown']) { stack1 = blockHelperMissing.call(depth0, 'p-markdown', {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(13, program13, data),contexts:[],types:[],data:data}); }
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n\n\n");
    stack1 = (helper = helpers['p-codigo'] || (depth0 && depth0['p-codigo']),options={hash:{
      'destacar': ("9-11,14-16,28-31")
    },hashTypes:{'destacar': "STRING"},hashContexts:{'destacar': depth0},inverse:self.noop,fn:self.program(15, program15, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-codigo", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n\n\n");
    options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(17, program17, data),contexts:[],types:[],data:data}
    if (helper = helpers['p-markdown']) { stack1 = helper.call(depth0, options); }
    else { helper = (depth0 && depth0['p-markdown']); stack1 = typeof helper === functionType ? helper.call(depth0, options) : helper; }
    if (!helpers['p-markdown']) { stack1 = blockHelperMissing.call(depth0, 'p-markdown', {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(17, program17, data),contexts:[],types:[],data:data}); }
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n\n");
    options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(19, program19, data),contexts:[],types:[],data:data}
    if (helper = helpers['p-codigo']) { stack1 = helper.call(depth0, options); }
    else { helper = (depth0 && depth0['p-codigo']); stack1 = typeof helper === functionType ? helper.call(depth0, options) : helper; }
    if (!helpers['p-codigo']) { stack1 = blockHelperMissing.call(depth0, 'p-codigo', {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(19, program19, data),contexts:[],types:[],data:data}); }
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n\n");
    options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(21, program21, data),contexts:[],types:[],data:data}
    if (helper = helpers['p-markdown']) { stack1 = helper.call(depth0, options); }
    else { helper = (depth0 && depth0['p-markdown']); stack1 = typeof helper === functionType ? helper.call(depth0, options) : helper; }
    if (!helpers['p-markdown']) { stack1 = blockHelperMissing.call(depth0, 'p-markdown', {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(21, program21, data),contexts:[],types:[],data:data}); }
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n\n");
    options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(23, program23, data),contexts:[],types:[],data:data}
    if (helper = helpers['p-codigo']) { stack1 = helper.call(depth0, options); }
    else { helper = (depth0 && depth0['p-codigo']); stack1 = typeof helper === functionType ? helper.call(depth0, options) : helper; }
    if (!helpers['p-codigo']) { stack1 = blockHelperMissing.call(depth0, 'p-codigo', {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(23, program23, data),contexts:[],types:[],data:data}); }
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n\n");
    options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(25, program25, data),contexts:[],types:[],data:data}
    if (helper = helpers['p-markdown']) { stack1 = helper.call(depth0, options); }
    else { helper = (depth0 && depth0['p-markdown']); stack1 = typeof helper === functionType ? helper.call(depth0, options) : helper; }
    if (!helpers['p-markdown']) { stack1 = blockHelperMissing.call(depth0, 'p-markdown', {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(25, program25, data),contexts:[],types:[],data:data}); }
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
...
define('pilas-website-test/templates/docs/guia-conversion', ['exports', 'ember'], function (exports, Ember) {
  ...
  function program3(depth0,data) {
    ...
    var buffer = '', stack1, helper, options;
    data.buffer.push("\n  ");
    stack1 = (helper = helpers['p-api-bloque'] || (depth0 && depth0['p-api-bloque']),options={hash:{
      'titulo': ("Antes")
    },hashTypes:{'titulo': "STRING"},hashContexts:{'titulo': depth0},inverse:self.noop,fn:self.program(4, program4, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-api-bloque", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n  ");
    stack1 = (helper = helpers['p-api-bloque'] || (depth0 && depth0['p-api-bloque']),options={hash:{
      'titulo': ("Después")
    },hashTypes:{'titulo': "STRING"},hashContexts:{'titulo': depth0},inverse:self.noop,fn:self.program(6, program6, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-api-bloque", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n");
    return buffer;
    }
  function program4(depth0,data) {
    ...
    data.buffer.push("import pilas");
    }

  function program6(depth0,data) {
    
    
    data.buffer.push("import pilasengine");
    }
  ...
  function program8(depth0,data) {
    ...
    stack1 = (helper = helpers['p-api-bloque'] || (depth0 && depth0['p-api-bloque']),options={hash:{
      'titulo': ("Antes")
    },hashTypes:{'titulo': "STRING"},hashContexts:{'titulo': depth0},inverse:self.noop,fn:self.program(9, program9, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-api-bloque", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n  ");
    stack1 = (helper = helpers['p-api-bloque'] || (depth0 && depth0['p-api-bloque']),options={hash:{
      'titulo': ("Después")
    },hashTypes:{'titulo': "STRING"},hashContexts:{'titulo': depth0},inverse:self.noop,fn:self.program(11, program11, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-api-bloque", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n");
    return buffer;
    }
  function program9(depth0,data) {
    ...
    data.buffer.push("pilas.iniciar()");
    }

  function program11(depth0,data) {
    
    
    data.buffer.push("pilas = pilasengine.iniciar()");
    }
  ...
  function program13(depth0,data) {
    ...
    stack1 = (helper = helpers['p-api-bloque'] || (depth0 && depth0['p-api-bloque']),options={hash:{
      'titulo': ("Antes")
    },hashTypes:{'titulo': "STRING"},hashContexts:{'titulo': depth0},inverse:self.noop,fn:self.program(14, program14, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-api-bloque", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n  ");
    stack1 = (helper = helpers['p-api-bloque'] || (depth0 && depth0['p-api-bloque']),options={hash:{
      'titulo': ("Después")
    },hashTypes:{'titulo': "STRING"},hashContexts:{'titulo': depth0},inverse:self.noop,fn:self.program(16, program16, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-api-bloque", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n");
    return buffer;
    }
  function program14(depth0,data) {
    ...
    data.buffer.push("pilas.actores.Actor(\"huevo.png\")");
    }

  function program16(depth0,data) {
    
    
    data.buffer.push("pilas.actores.Actor(imagen=\"huevo.png\")");
    }
  ...
  function program18(depth0,data) {
    ...
    stack1 = (helper = helpers['p-api-bloque'] || (depth0 && depth0['p-api-bloque']),options={hash:{
      'titulo': ("Antes")
    },hashTypes:{'titulo': "STRING"},hashContexts:{'titulo': depth0},inverse:self.noop,fn:self.program(19, program19, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-api-bloque", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n  ");
    stack1 = (helper = helpers['p-api-bloque'] || (depth0 && depth0['p-api-bloque']),options={hash:{
      'titulo': ("Después")
    },hashTypes:{'titulo': "STRING"},hashContexts:{'titulo': depth0},inverse:self.noop,fn:self.program(21, program21, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-api-bloque", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n");
    return buffer;
    }
  ...
  function program23(depth0,data) {
    ...
    stack1 = (helper = helpers['p-api-bloque'] || (depth0 && depth0['p-api-bloque']),options={hash:{
      'titulo': ("Antes")
    },hashTypes:{'titulo': "STRING"},hashContexts:{'titulo': depth0},inverse:self.noop,fn:self.program(24, program24, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-api-bloque", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n  ");
    stack1 = (helper = helpers['p-api-bloque'] || (depth0 && depth0['p-api-bloque']),options={hash:{
      'titulo': ("Después")
    },hashTypes:{'titulo': "STRING"},hashContexts:{'titulo': depth0},inverse:self.noop,fn:self.program(26, program26, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-api-bloque", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n");
    return buffer;
    }
  function program24(depth0,data) {
    ...
    data.buffer.push("class Spiderman(pilas.actores.Actor):\n    def __init__(self, y=0):\n        ….\n\nprota = Spiderman(500)\n");
    }

  function program26(depth0,data) {
    
    
    data.buffer.push("class Spiderman(pilasengine.actores.Actor):\n    def iniciar(self, y=0):\n        ...\n\npilas.actores.vincular(Spiderman)\n\nprota = pilas.actores.Spiderman(y=500)");
    }
  ...
  function program28(depth0,data) {
    ...
    stack1 = (helper = helpers['p-api-bloque'] || (depth0 && depth0['p-api-bloque']),options={hash:{
      'titulo': ("Antes")
    },hashTypes:{'titulo': "STRING"},hashContexts:{'titulo': depth0},inverse:self.noop,fn:self.program(29, program29, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-api-bloque", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n  ");
    stack1 = (helper = helpers['p-api-bloque'] || (depth0 && depth0['p-api-bloque']),options={hash:{
      'titulo': ("Después")
    },hashTypes:{'titulo': "STRING"},hashContexts:{'titulo': depth0},inverse:self.noop,fn:self.program(31, program31, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-api-bloque", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n");
    return buffer;
    }
  function program29(depth0,data) {
    ...
    data.buffer.push("pilas.grupo.Grupo()");
    }

  function program31(depth0,data) {
    
    
    data.buffer.push("pilas.actores.Grupo()");
    }
  ...
  function program33(depth0,data) {
    ...
    stack1 = (helper = helpers['p-api-bloque'] || (depth0 && depth0['p-api-bloque']),options={hash:{
      'titulo': ("Antes")
    },hashTypes:{'titulo': "STRING"},hashContexts:{'titulo': depth0},inverse:self.noop,fn:self.program(34, program34, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-api-bloque", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n  ");
    stack1 = (helper = helpers['p-api-bloque'] || (depth0 && depth0['p-api-bloque']),options={hash:{
      'titulo': ("Después")
    },hashTypes:{'titulo': "STRING"},hashContexts:{'titulo': depth0},inverse:self.noop,fn:self.program(36, program36, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-api-bloque", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n");
    return buffer;
    }
  function program34(depth0,data) {
    ...
    data.buffer.push("class EscenaMenu(pilas.escena.Base):\n\n    def __init__(self):\n        pilas.escena.Base.__init__(self)\n        ….\n\n    def iniciar(self):\n        pilas.fondos.Fondo(\"corazones.png\")\n        ….\n\npilas.cambiar_escena(EscenaMenu())");
    }

  function program36(depth0,data) {
    
    
    data.buffer.push("class EscenaMenu(pilasengine.escenas.Escena):\n\n    def iniciar(self):\n        pilas.fondos.Fondo(\"corazones.png\")\n        ….\n\n\npilas.escenas.vincular(EscenaMenu)\n\n\npilas.escenas.EscenaMenu()");
    }
  ...
  function program38(depth0,data) {
    ...
    stack1 = (helper = helpers['p-api-bloque'] || (depth0 && depth0['p-api-bloque']),options={hash:{
      'titulo': ("Antes")
    },hashTypes:{'titulo': "STRING"},hashContexts:{'titulo': depth0},inverse:self.noop,fn:self.program(39, program39, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-api-bloque", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n  ");
    stack1 = (helper = helpers['p-api-bloque'] || (depth0 && depth0['p-api-bloque']),options={hash:{
      'titulo': ("Después")
    },hashTypes:{'titulo': "STRING"},hashContexts:{'titulo': depth0},inverse:self.noop,fn:self.program(41, program41, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-api-bloque", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n");
    return buffer;
    }
  function program39(depth0,data) {
    ...
    data.buffer.push("pilas.escena_actual().colisiones.agregar(sprite, sprite2, rebotar)");
    }

  function program41(depth0,data) {
    
    
    data.buffer.push("pilas.colisiones.agregar(sprite, sprite2, rebotar)");
    }
  ...
  function program43(depth0,data) {
    ...
    stack1 = (helper = helpers['p-api-bloque'] || (depth0 && depth0['p-api-bloque']),options={hash:{
      'titulo': ("Antes")
    },hashTypes:{'titulo': "STRING"},hashContexts:{'titulo': depth0},inverse:self.noop,fn:self.program(44, program44, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-api-bloque", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n  ");
    stack1 = (helper = helpers['p-api-bloque'] || (depth0 && depth0['p-api-bloque']),options={hash:{
      'titulo': ("Después")
    },hashTypes:{'titulo': "STRING"},hashContexts:{'titulo': depth0},inverse:self.noop,fn:self.program(46, program46, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-api-bloque", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n");
    return buffer;
    }
  ...
  function program48(depth0,data) {
    ...
    stack1 = (helper = helpers['p-api-bloque'] || (depth0 && depth0['p-api-bloque']),options={hash:{
      'titulo': ("Antes")
    },hashTypes:{'titulo': "STRING"},hashContexts:{'titulo': depth0},inverse:self.noop,fn:self.program(49, program49, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-api-bloque", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n  ");
    stack1 = (helper = helpers['p-api-bloque'] || (depth0 && depth0['p-api-bloque']),options={hash:{
      'titulo': ("Después")
    },hashTypes:{'titulo': "STRING"},hashContexts:{'titulo': depth0},inverse:self.noop,fn:self.program(51, program51, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-api-bloque", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n");
    return buffer;
    }
  function program49(depth0,data) {
    ...
    data.buffer.push("mandos = pilas.control.Control(pilas.escena_actual(), teclas)");
    }

  function program51(depth0,data) {
    
    
    data.buffer.push("mandos = pilas.control.Control(teclas)");
    }
  ...
  function program53(depth0,data) {
    ...
    stack1 = (helper = helpers['p-api-bloque'] || (depth0 && depth0['p-api-bloque']),options={hash:{
      'titulo': ("Antes")
    },hashTypes:{'titulo': "STRING"},hashContexts:{'titulo': depth0},inverse:self.noop,fn:self.program(54, program54, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-api-bloque", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n  ");
    stack1 = (helper = helpers['p-api-bloque'] || (depth0 && depth0['p-api-bloque']),options={hash:{
      'titulo': ("Después")
    },hashTypes:{'titulo': "STRING"},hashContexts:{'titulo': depth0},inverse:self.noop,fn:self.program(56, program56, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-api-bloque", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n");
    return buffer;
    }
  function program54(depth0,data) {
    ...
    data.buffer.push("class Esperando(pilas.comportamientos.Comportamiento):\n    def __init__(self, receptor):\n        ….\n\n\nmi_actor.hacer(Esperando())");
    }
  ...
  function program58(depth0,data) {
    ...
    stack1 = (helper = helpers['p-api-bloque'] || (depth0 && depth0['p-api-bloque']),options={hash:{
      'titulo': ("Antes")
    },hashTypes:{'titulo': "STRING"},hashContexts:{'titulo': depth0},inverse:self.noop,fn:self.program(59, program59, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-api-bloque", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n  ");
    stack1 = (helper = helpers['p-api-bloque'] || (depth0 && depth0['p-api-bloque']),options={hash:{
      'titulo': ("Después")
    },hashTypes:{'titulo': "STRING"},hashContexts:{'titulo': depth0},inverse:self.noop,fn:self.program(61, program61, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-api-bloque", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n");
    return buffer;
    }
  function program59(depth0,data) {
    ...
    data.buffer.push("class Cantar(pilas.habilidades.Habilidad):\n    def __init__(self, receptor)\n        ….\n\nmi_actor.aprender(Cantar)");
    }

  function program61(depth0,data) {
    
    
    data.buffer.push("class Cantar(pilasengine.habilidades.Habilidad):\n    ….\n\npilas.habilidades.vincular(Cantar)\nmi_actor.aprender(\"Cantar\")");
    }
  ...
  function program63(depth0,data) {
    ...
    stack1 = (helper = helpers['p-api-bloque'] || (depth0 && depth0['p-api-bloque']),options={hash:{
      'titulo': ("Antes")
    },hashTypes:{'titulo': "STRING"},hashContexts:{'titulo': depth0},inverse:self.noop,fn:self.program(64, program64, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-api-bloque", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n  ");
    stack1 = (helper = helpers['p-api-bloque'] || (depth0 && depth0['p-api-bloque']),options={hash:{
      'titulo': ("Después")
    },hashTypes:{'titulo': "STRING"},hashContexts:{'titulo': depth0},inverse:self.noop,fn:self.program(66, program66, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "p-api-bloque", options));
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n");
    return buffer;
    }
  ...
  function program66(depth0,data) {
    ...
    options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(3, program3, data),contexts:[],types:[],data:data}
    if (helper = helpers['p-api']) { stack1 = helper.call(depth0, options); }
    else { helper = (depth0 && depth0['p-api']); stack1 = typeof helper === functionType ? helper.call(depth0, options) : helper; }
    if (!helpers['p-api']) { stack1 = blockHelperMissing.call(depth0, 'p-api', {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(3, program3, data),contexts:[],types:[],data:data}); }
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    ...
    if (!helpers['p-api']) { stack1 = blockHelperMissing.call(depth0, 'p-api', {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(8, program8, data),contexts:[],types:[],data:data}); }
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n\n\n<p>Las parámetros en los actores derivados se han de cargar nombrando el argumento.</p>\n\n");
    options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(13, program13, data),contexts:[],types:[],data:data}
    if (helper = helpers['p-api']) { stack1 = helper.call(depth0, options); }
    else { helper = (depth0 && depth0['p-api']); stack1 = typeof helper === functionType ? helper.call(depth0, options) : helper; }
    if (!helpers['p-api']) { stack1 = blockHelperMissing.call(depth0, 'p-api', {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(13, program13, data),contexts:[],types:[],data:data}); }
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    ...
    if (!helpers['p-api']) { stack1 = blockHelperMissing.call(depth0, 'p-api', {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(18, program18, data),contexts:[],types:[],data:data}); }
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    ...
    if (!helpers['p-api']) { stack1 = blockHelperMissing.call(depth0, 'p-api', {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(23, program23, data),contexts:[],types:[],data:data}); }
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    ...
    if (!helpers['p-api']) { stack1 = blockHelperMissing.call(depth0, 'p-api', {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(28, program28, data),contexts:[],types:[],data:data}); }
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    ...
    if (!helpers['p-api']) { stack1 = blockHelperMissing.call(depth0, 'p-api', {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(33, program33, data),contexts:[],types:[],data:data}); }
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n\n<p>Las colisiones se pueden agregar directamente desde su módulo (aunque el método anterior sigue siendo posible también).\n</p>\n\n");
    options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(38, program38, data),contexts:[],types:[],data:data}
    if (helper = helpers['p-api']) { stack1 = helper.call(depth0, options); }
    else { helper = (depth0 && depth0['p-api']); stack1 = typeof helper === functionType ? helper.call(depth0, options) : helper; }
    if (!helpers['p-api']) { stack1 = blockHelperMissing.call(depth0, 'p-api', {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(38, program38, data),contexts:[],types:[],data:data}); }
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n\n\n\n<p>Las tareas ahora están en un módulo que las agrupa a todas:</p>\n\n");
    options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(43, program43, data),contexts:[],types:[],data:data}
    if (helper = helpers['p-api']) { stack1 = helper.call(depth0, options); }
    else { helper = (depth0 && depth0['p-api']); stack1 = typeof helper === functionType ? helper.call(depth0, options) : helper; }
    if (!helpers['p-api']) { stack1 = blockHelperMissing.call(depth0, 'p-api', {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(43, program43, data),contexts:[],types:[],data:data}); }
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n\n\n<p>Los controles personalizados no requieren que se les pase la escena\n</p>\n\n\n");
    options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(48, program48, data),contexts:[],types:[],data:data}
    if (helper = helpers['p-api']) { stack1 = helper.call(depth0, options); }
    else { helper = (depth0 && depth0['p-api']); stack1 = typeof helper === functionType ? helper.call(depth0, options) : helper; }
    if (!helpers['p-api']) { stack1 = blockHelperMissing.call(depth0, 'p-api', {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(48, program48, data),contexts:[],types:[],data:data}); }
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    ...
    options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(53, program53, data),contexts:[],types:[],data:data}
    if (helper = helpers['p-api']) { stack1 = helper.call(depth0, options); }
    else { helper = (depth0 && depth0['p-api']); stack1 = typeof helper === functionType ? helper.call(depth0, options) : helper; }
    if (!helpers['p-api']) { stack1 = blockHelperMissing.call(depth0, 'p-api', {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(53, program53, data),contexts:[],types:[],data:data}); }
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push("\n\n\n<p>Las habilidades (personalizadas) siguen de forma coherente el esquema de los comportamientos\n</p>\n\n");
    options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(58, program58, data),contexts:[],types:[],data:data}
    if (helper = helpers['p-api']) { stack1 = helper.call(depth0, options); }
    else { helper = (depth0 && depth0['p-api']); stack1 = typeof helper === functionType ? helper.call(depth0, options) : helper; }
    if (!helpers['p-api']) { stack1 = blockHelperMissing.call(depth0, 'p-api', {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(58, program58, data),contexts:[],types:[],data:data}); }
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    ...
    options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(63, program63, data),contexts:[],types:[],data:data}
    if (helper = helpers['p-api']) { stack1 = helper.call(depth0, options); }
    else { helper = (depth0 && depth0['p-api']); stack1 = typeof helper === functionType ? helper.call(depth0, options) : helper; }
    if (!helpers['p-api']) { stack1 = blockHelperMissing.call(depth0, 'p-api', {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(63, program63, data),contexts:[],types:[],data:data}); }
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
...
define('pilas-website-test/templates/docs/index', ['exports', 'ember'], function (exports, Ember) {
...
define('pilas-website-test/templates/foro', ['exports', 'ember'], function (exports, Ember) {
  ...
  helpers = this.merge(helpers, Ember['default'].Handlebars.helpers); data = data || {};
    ...
    data.buffer.push("<div class=\"page-header center\">\n  <h1>Foro de la comunidad</h1>\n</div>\n\n<div class=\"bs-component\">\n  <div class='row'>\n\n    <div style='text-align: center'>\n     <a class=\"aligncenter\" href='http://foro.pilas-engine.com.ar/' target=\"_blank\"><img class=\"aligncenter\" src=\"./images/completamente-castellano-a838137aaf57a37f4f8ecb6bf0a66eff.png\" alt=\"Completamente es castellano\" /></a>\n     <p>\n     <a class=\"aligncenter\" href='http://foro.pilas-engine.com.ar/' target=\"_blank\">Abrir el foro en una ventana nueva</a>\n    </div>\n\n\n  </div>\n</div>\n");
