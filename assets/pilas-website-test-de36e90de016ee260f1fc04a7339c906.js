...
define('pilas-website-test/templates/docs/index', ['exports', 'ember'], function (exports, Ember) {
  ...
  helpers = this.merge(helpers, Ember['default'].Handlebars.helpers); data = data || {};
    ...
    data.buffer.push(escapeExpression((helper = helpers['link-tutorial'] || (depth0 && depth0['link-tutorial']),options={hash:{
      ...
      'titulo': ("Guía de conversión a la nueva versión de pilsa-engine"),
